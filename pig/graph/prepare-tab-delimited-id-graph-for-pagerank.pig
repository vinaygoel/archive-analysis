...
PRTabGraph = FOREACH Graph GENERATE src, 1 as pagerank, COLLECTBAGELEMENTS.collectBagElements(dests) as destString;
Store PRTabGraph into '$O_PR_TAB_ID_GRAPH_DIR';
